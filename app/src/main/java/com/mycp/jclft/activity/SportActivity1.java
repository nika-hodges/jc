...
import com.mycp.jclft.fragment.BasketballFragment;
import com.mycp.jclft.fragment.FootballFragment;
...
public class SportActivity1 extends AppCompatActivity {
...
//                }
    ...
    private void initView() {
        ...
        initFragments();
        mSportAdapter = new SportAdapter(getSupportFragmentManager(), this);
        mSportAdapter.setData(mFragments);
        mViewPager.setAdapter(mSportAdapter);
        mTabLayout.getTabAt(0).setText("足球");
        mTabLayout.getTabAt(1).setText("篮球");
        mViewPager.setOffscreenPageLimit(1);
    }

    private void initFragments() {
        mFragments = new ArrayList<>();
        mFragments.add(new FootballFragment());
        mFragments.add(new BasketballFragment());
    }
